function insert_shortcut(form){ return legacy_filter('insert_shortcut', form, 'admin', 'procAdminInsertShortCut', filterAlertMessage, ['error','message'], '등록하시겠습니까?', {}) };
(function($){
	var v=xe.getApp('validator')[0];if(!v)return false;
	v.cast("ADD_FILTER", ["insert_shortcut", {'module': {required:true}}]);
