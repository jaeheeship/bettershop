function delete_checked(form){ return legacy_filter('delete_checked', form, 'document', 'procDocumentAdminDeleteChecked', filterAlertMessage, ['error','message'], '삭제하시겠습니까?', {}) };
(function($){
	var v=xe.getApp('validator')[0];if(!v)return false;
	v.cast("ADD_FILTER", ["delete_checked", {'cart': {required:true}}]);
	
	v.cast('ADD_MESSAGE',['cart','선택항목']);
