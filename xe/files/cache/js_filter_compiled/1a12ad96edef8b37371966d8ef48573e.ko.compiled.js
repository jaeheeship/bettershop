function manage_checked_document(form){ return legacy_filter('manage_checked_document', form, 'document', 'procDocumentManageCheckedDocument', completeManageDocument, ['error','message'], '', {}) };
(function($){
	var v=xe.getApp('validator')[0];if(!v)return false;
	v.cast("ADD_FILTER", ["manage_checked_document", {}]);
