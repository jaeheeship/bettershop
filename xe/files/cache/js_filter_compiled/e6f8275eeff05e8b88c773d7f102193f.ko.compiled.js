function delete_image_name(form){ return legacy_filter('delete_image_name', form, 'member', 'procMemberDeleteImageName', filterAlertMessage, [], '삭제하시겠습니까?', {}) };
(function($){
	var v=xe.getApp('validator')[0];if(!v)return false;
	v.cast("ADD_FILTER", ["delete_image_name", {}]);
