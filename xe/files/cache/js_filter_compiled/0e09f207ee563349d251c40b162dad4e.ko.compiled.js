function update_lang_select(form){ return legacy_filter('update_lang_select', form, 'install', 'procInstallAdminSaveLangSelected', completeMessage, ['error','message'], '', {}) };
(function($){
	var v=xe.getApp('validator')[0];if(!v)return false;
	v.cast("ADD_FILTER", ["update_lang_select", {}]);
