function update_env_config(form){ return legacy_filter('update_env_config', form, 'install', 'procInstallAdminSaveTimeZone', completeMessage, ['error','message'], '', {}) };
(function($){
	var v=xe.getApp('validator')[0];if(!v)return false;
	v.cast("ADD_FILTER", ["update_env_config", {'time_zone': {required:true}}]);
	
	v.cast('ADD_MESSAGE',['time_zone','time_zone']);
