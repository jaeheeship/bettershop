<?php
    ...
    class fileController extends file {
        ...
        function insertFileBS2($file_info, $module_srl, $upload_target_srl, $download_count = 0, $manual_insert = false, $member_srl) {

			//return TRUE;
			
			
			$absolute_path = sprintf("/var/www/html/xe14/files/attach/images/%s/%s", $module_srl,getNumberingPath($upload_target_srl,3));
			$path = sprintf("./files/attach/images/%s/%s", $module_srl,getNumberingPath($upload_target_srl,3));
            ...
            //if(!FileHandler::makeDir($absolute_path)) return FALSE;
			...
			$filesize = @filesize('/var/www/html/xe14/'.$filename);
            ...
            $args->uploaded_filename = $filename;
            $args->download_count = $download_count;
            $args->file_size = $filesize;               //@filesize($filename);
            $args->comment = NULL;
            $args->member_srl = $member_srl;
            $args->sid = md5(rand(rand(1111111,4444444),rand(4444445,9999999)));
			$args->isvalid = 'Y';
